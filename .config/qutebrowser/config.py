...
# Enable Dark mode on all possible websites
config.set("colors.webpage.darkmode.enabled", True)

# disable some keys in some websites
# config.bind("<>jkli", "copy", mode="normal", url="https://youtube.com/*")
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/francis/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/francis/.local/share/qutebrowser/userscripts/*')
